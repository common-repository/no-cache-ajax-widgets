	...
	class AJAX_Text_Widget extends WP_Widget {
		...
		public function widget($args, $instance) {
			...
			echo $before_widget; ?>
				...
				<?php if (empty($text))	{?><div class="mg_ajax_widget" data-text="<?php echo $text; ?>"><img src="<?php echo plugins_url( '/img/loading.GIF', __FILE__ ); ?>" alt="loading" /></div>
				<?php } else {echo do_shortcode($text);}?> 
